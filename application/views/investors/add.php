...
<script>
    ...
    var userSportbookList = [];
</script>
<div class="container page-title">
    <h1 class="text-center">Add New Investor</h1>
</div>
    ...
    <form method="post" class="form">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-6 col-sm-12">
                ...
                <input required type="text" name="starting_bankroll" class="form-control" id="starting_bankroll" placeholder="Enter Starting BankRoll">
            </div>

            <div class="form-group col-md-6 col-sm-12">
                <label for="siteurl">Current Balance</label>
                <span class="info" id="current_balance">$ 0</span>
